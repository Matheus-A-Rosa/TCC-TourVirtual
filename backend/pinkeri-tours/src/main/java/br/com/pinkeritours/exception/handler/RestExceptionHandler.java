...
//  }
  ...
  protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex,
    ...
    String msg = String.format(
        "Campo esperava receber o tipo '%s' mas recebeu o valor '%s' com o tipo '%s'",
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
    ...
    List<FieldMessage> errors = ex.getBindingResult().getFieldErrors().stream()
        .map(err -> new FieldMessage(err.getDefaultMessage(), err.getField(),
  ...
  protected ResponseEntity<Object> handleMissingServletRequestParameter(
      ...
      HttpStatus status,
      WebRequest request) {
    String message = "O parâmetro " + ex.getParameterName() + " do tipo " + ex.getParameterType()
        + " é obrigatório ";
  ...
  private ResponseEntity<Object> handleInvalidFormatException(InvalidFormatException ex,
    ...
    String msg = String.format("O campo '%s' esperava receber o tipo '%s', " +
        ...
        fieldName, ex.getTargetType().getSimpleName(), ex.getValue(),
